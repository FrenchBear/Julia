...
div(y3,3) # mirrors integer division
3 years

Dates.value(Dates.Millisecond(10))
10
...
cp = Dates.CompoundPeriod(Day(1),Minute(1))
1 day, 1 minute

t1 = DateTime(2018,8,8,16,58,00)
2018-08-08T16:58:00

t2 = DateTime(2021,6,23,10,00,00)
2021-06-23T10:00:00

canonicalize(t2-t1) # creates a CompoundPeriod
